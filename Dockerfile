# Docker image for proftp using the alpine template
ARG IMAGE_NAME="proftp"
ARG PHP_SERVER="proftp"
ARG BUILD_DATE="Wed Jun 26 10:11:48 AM EDT 2024"
...
ARG IMAGE_REPO="casjaysdevdocker/proftp"
...
ENV HOSTNAME="casjaysdev-proftp"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/proftp" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/proftp" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/proftp" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/proftp" \
